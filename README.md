# PY-Weather-Forecast-for-turkish

TR

Python ile yazılmış Basit bir hava durumu çalıştırmak için cmd üzerinden Başlatınız veya herhangi bir python editörüde olabilir.
Mesela ben bunu Visual Studio Code ile yazıp Onun terminalinden test etmiştim tabikide sizin keyfiniz nasıl isterse
